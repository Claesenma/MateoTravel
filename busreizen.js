...
function get_airports() {
  ...
  fetch('https://tequila-api.kiwi.com/locations/dump?locale=nl-NL&location_types=bus_station&sort=name&limit=4000', {headers: headers2})
  .then(response => {
